...
permalink: /404.html
---
<! -- // https://dribbble.com/shots/3947723-Portfolio-404-->
...
head {
  ...
  z-index: -1;
  box-shadow:
    0 0 0 2rem hsla(var(--main-color-hue), 97%, 61%, .1),
    0 0 0 4rem hsla(var(--main-color-hue), 97%, 61%, .05),
    0 0 0 6rem hsla(var(--main-color-hue), 97%, 61%, .025)
  ;
  @extend %center;
